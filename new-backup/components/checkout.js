...
<section class="bg-rie-dark dark:bg-gray-900 overflow-hidden py-16 lg:py-1">
      <div class="py-1 px-4 mx-auto max-w-screen-xl text-center lg:py-16 mycenter"
        ...
        <h1 class=" mb-4 text-3xl font-normal tracking-tight leading-none text-white md:text-5xl lg:text-4xl font-mblack dark:text-white">Checkout Our Past Events</h1>
        <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
        <a href="http://riekol.com/" class="text-white bg-rie-pink hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg inline-flex justify-center hover:text-rie-pink items-center py-5 px-12 sm:ms-4 text-4xl font-thin text-center text-white rounded-full border-2 border-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-400 tracking-wide">
        RIE KOLKATA
