...
function HomePageBanner() {
  ...
  return (
        ...
        <nav class="transparent">
          <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <Link href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
              <Image src="/images/logo.png" class="w-full" alt="EO RIE" width={140} height={60} />
            </Link>
            {/* modal start here */}
      ...
      <div className='hidden lg:block'>
        ...
        >
          <div className="flex-1">
            <Image src="/images/top-left-circle.svg" width={300} height={200} className="-ml-24" /></div>
          <div className="content-end">
            <Image src="/images/top-right-circle.svg" width={350} height={200} className="-mr-44" /></div>
        </div>
      </div>
      <div class="lg:px-4 mx-auto max-w-screen-xl text-white text-center py-12 lg:py-20  lg:text-7xl lg:pb-24 lg:pt-1 lg:mt-0 font-extrabold font-mblack z-50 -mt-20 pb-30 pt-20 pb-40 mt-0 md:mb-20"
        data-aos="flip-right"
      >
    ...
    <div className="mt-36 mb-10 lg:mt-80 lg:mb-28 md:mt-40">
        <h1 className='lg:text-7xl text-4xl md:text-6xl'>Think<br />You’ve Got</h1>
        <p className="lg:text-5xl text-2xl md:text-4xl font-msemibold">What It Takes?</p>
        <p className="lg:text-4xl text-xl md:text-4xl font-avertalight text-rie-yellow">EO 2025</p>
        <p className="lg:text-4xl text-xl md:text-4xl font-avertalight">South Asia RIE</p>
        </div>
      </div>
